...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/work1/aroger/anatolejdm/checkpoints/robin_full_test_split/pretrain/checkpoint-300")
    parser.add_argument("--model-base", type=str, default="/work1/aroger/shared/downloaded_models/OpenHermes-2.5-Mistral-7B")
    parser.add_argument("--image-folder", type=str, default="/work1/aroger/shared/data/evals/scienceqa/images")
    parser.add_argument("--question-file", type=str, default="/work1/aroger/shared/data/evals/scienceqa/llava_test_CQM-A.json")
