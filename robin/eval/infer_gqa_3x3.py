...
def main():
    parser = argparse.ArgumentParser(description="Run Robin inference on GQA-like dataset")
...
def process_questions(args):
    ...
    MODEL_ID = "EVAL_full_split_3x3_ViT_SO400M_14_SigLIP_384"
