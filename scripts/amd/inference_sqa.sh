...
TEMPERATURE=0
MAX_NEW_TOKENS=100
IMAGE_PATH="/work1/aroger/shared/data/evals/scienceqa/images/test"

# Set CUDA device
export CUDA_VISIBLE_DEVICES=0

# Run the Python script with the parameters
python /work1/aroger/anatolejdm/robin/robin/eval/infer_sqa_3x3.py \
    --conv_mode "$CONV_MODE" \
    --temperature "$TEMPERATURE" \
    --model_base "$MODEL_BASE" \
    --checkpoint_path "$CHECKPOINT_PATH" \
    --images "$IMAGE_PATH" \
    --query_path "/work1/aroger/shared/data/evals/scienceqa/llava_test_CQM-A.json" \
    --output_file "/work1/aroger/shared/data/evals/scienceqa/answers/$MODEL_NAME.jsonl" \