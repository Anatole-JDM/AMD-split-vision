...
# only change this
NAME=split_3x2_ViT_SO400M_14_SigLIP_384
MODEL=OpenHermes-2.5-Mistral-7B
VISION=SplitVisionTransformer3x2
GAS=8
...
DATA_PATH=/work1/aroger/shared/data
...
deepspeed \
    ...
    --version v1 \
    --data_path $DATA_PATH/Monkey_Train_data/train_monkey_2.json  \
    --split_shape 3x2 \
    --image_folder $DATA_PATH/Monkey_Train_data \
    --vision_tower $VISION \
    --finetune_ve True \
